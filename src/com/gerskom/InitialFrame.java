...
public class InitialFrame extends JFrame {
    ...
    JTextField gameWidth = new JTextField("800");
    JTextField gameHeight = new JTextField("800");
    JTextField gameNMax = new JTextField("300000");
    ...
    InitialFrame() {
        ...
        startButton.addActionListener( e -> {
            ...
            new MainFrame(new Grid(width, height, nMax));
